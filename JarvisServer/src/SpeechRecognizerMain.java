...
class SpeechRecognizerMain {
	 ...
	 */
	public String speechRecognitionResult="null";
	...
	public SpeechRecognizerMain() {
		...
		//startSpeechRecognition();  //i have intentionall commented it so that i can controll this program in my way -----hrithik
	}
	...
	public synchronized void startSpeechRecognition() {
		...
		/*if (speechRecognizerThreadRunning)
			logger.log(Level.INFO, "Speech Recognition Thread already running...\n");*/   //i have intentionally commented this -----hrithik
	...
	void recognizingMode(boolean option)
	{
		speechRecognizerThreadRunning=option;
